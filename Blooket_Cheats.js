...
(() => {
    ...
    const cheat = (async () => {
        ...
        let settings, settingsKey = "@XeonYTWasHere";
        const Settings = {
            data: null,
            setItem(k, v) {
        ...
        const guiWrapper = createElement("div", {
            ...
            (gui = createElement("div", {
                ...
                createElement("div", {
                    ...
                    innerHTML: "GitHub - Xeon_yt",
                    onclick: () => window.open("https://github.com/XeonGames-official/Blooket-Hacks", "_blank").focus()
                }),
                ...
                (cheatContainer = createElement("div", {
                    ...
                    createElement("a", {
                        ...
                        target: "_blank",
                        href: "https://github.com/XeonGames-official/Blooket-Hacks",
